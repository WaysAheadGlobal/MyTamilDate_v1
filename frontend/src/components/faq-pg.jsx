...
export const FaqPage = () => {
    ...
    const faqs = [
        ...
        },
        {
          ...
          answer: "Online dating can be a cheaper (Going out to meet singles in major cities can be super pricey!), convenient, and more effective way to meet singles. That said, you should still exercise caution as you would with offline dating. Here are some safety tips you can follow."
        }
      ];
  ...
  lineHeight: '34px',
  textAlign: 'left',
  color: '#F76A7B' }}>info@myTamilDate.com</a></span>
  </div>
                </div>
