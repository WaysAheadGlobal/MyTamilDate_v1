  ...
  async function addPaymentMethod(e) {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setError(
          data.message || "An error occurred while creating the payment method."
        );
      }
    } catch (fetchError) {
        ...
        <Container>
          ...
          >
            <Container className="logo-arrow3">
              ...
              />
              <h1
                className="account-setting-heading"
                style={{ color: "#515151" }}
              >
                Add Payments
              </h1>
          ...
          <div className={pay.formContainer}>
            <form key={key} onSubmit={addPaymentMethod}>
              ...
              <div className={pay.formGroup}>
                <div className={pay.detailandclear}>
                  ...
                  >
                    {" "}
                    <span>
                      <Image src={deleteicon} style={{ marginRight: "5px" }} />
                    </span>
                    Clear
                  </label>
                </div>
              ...
              <div className={pay.subscribeButtonContainer}>
                <button type="submit" className={pay.subscribeButtonn}>
                  Add
                </button>
              </div>
              ...
              <p className={pay.textmuted}>
                Your subscription will automatically renew for the same package
                length at the same price until you cancel in settings in your
                MTD account. By subscribing, you agree to our{" "}
                <a
              ...
              <p className={pay.textmuted}>
                Billed in CAD. Other conversions are estimates only. Actual
                charge may vary based on exchange rates.
              </p>
            </form>
          </div>
        </Container>
