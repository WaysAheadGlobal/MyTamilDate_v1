...
const Paymentfinal = () => {
    ...
    const [product, setProduct] = useState(process.env.REACT_APP_STRIPE_PRODUCT_ID_3_MONTHS);
                            ...
                            <div className={pay.cardContainer}>
                                ...
                                <div
                                    ...
                                    <div className={pay.cardBodypopular} style={{
                                        ...
                                        <p className={pay.subtotal}>
                                            ({/* getPrice(149.99, process.env.REACT_APP_STRIPE_PRODUCT_ID_6_MONTHS) */ price.m6.total} total)
                                        </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <p>
                                    <span style={{ marginRight: "20px" }}>
                                        <svg width="27" height="27" viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M19.25 7.75H19.2375M2.2625 15.7625L11.225 24.725C11.4572 24.9574 11.7329 25.1418 12.0364 25.2677C12.3399 25.3935 12.6652 25.4582 12.9937 25.4582C13.3223 25.4582 13.6476 25.3935 13.9511 25.2677C14.2546 25.1418 14.5303 24.9574 14.7625 24.725L25.5 14V1.5H13L2.2625 12.2375C1.79687 12.7059 1.53552 13.3395 1.53552 14C1.53552 14.6605 1.79687 15.2941 2.2625 15.7625Z" stroke="#242424" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
                                        </svg>
                                    </span>
