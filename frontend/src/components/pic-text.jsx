        ...
        <div className='pic-text-main'>
            <div className='pic1-text1 lineht '>
                ...
                <div className='text1 '>
                    ...
                    <a href='https://tamilculture.com/mytamildate-success-abi-john-bonded-over-faith-their-tamil-german-british-connection' target="_blank" className='view-success-btn' style={{
                        alignSelf: "center"
