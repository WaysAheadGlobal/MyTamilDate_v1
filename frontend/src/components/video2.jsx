    ...
    return (
        ...
        <Container className=' video2-main'>
            ...
            <Container className='video2-content'>
                <a  href="https://www.instagram.com/reel/CbiMcvWDt_V/"   className='vid2' >
                    <img   className='video2-img' src={vd1}>
                    </img>
                    <div className='play-icon'></div>

                </a>
                 <a href='https://www.instagram.com/reel/C6EPQwmvOPp/'  className='vid2'>
                ...
                <a href='https://www.instagram.com/reel/CsT1_nlB5VR/'  className='vid2'>
