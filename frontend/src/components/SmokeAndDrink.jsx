                ...
                <Container className='job-content'>
                        ...
                        <div className='your-job'>
                            <Container className='job-text'>
                                <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="20" cy="20" r="18" fill="url(#paint0_linear_778_6407)" />
                                    ...
                                    <defs>
                                        <linearGradient id="paint0_linear_778_6407" x1="21.4492" y1="0.5" x2="21.4491" y2="41.75" gradientUnits="userSpaceOnUse">
                    ...
                    <Container className='job-details'>
                        <div className='your-job'>
                            <Container className='job-text'>
                                <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="20" cy="20" r="18" fill="url(#paint0_linear_778_6415)" />
                                    ...
                                    <defs>
                                        <linearGradient id="paint0_linear_778_6415" x1="21.4492" y1="0.5" x2="21.4491" y2="41.75" gradientUnits="userSpaceOnUse">
                                            <stop stop-color="#FC8C66" />
                                            <stop offset="1" stop-color="#F76A7B" />
                                        </linearGradient>
                                    </defs>
